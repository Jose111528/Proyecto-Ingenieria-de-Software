...
var productosController = require('../controllers/productos.controller'); // Rutas para productos
...
router["delete"]('/productos/:id', productosController.deleteProducto); // Ruta de búsqueda de productos
