...
var app = express(); // Configuración de CORS para permitir solicitudes desde el frontend

var corsOptions = {
  origin: 'http://localhost:3001',
  // Aquí debe estar la URL de tu frontend
  methods: ['GET', 'POST', 'PUT', 'DELETE'],
  allowedHeaders: ['Content-Type', 'Authorization']
};
app.use(cors(corsOptions)); // Middleware para procesar datos JSON

app.use(bodyParser.json()); // Ruta de prueba para verificar la conexión a la base de datos
...
app.use('/api', ventasRoutes); // Iniciar el servidor en el puerto 3000
